  ...
  return (
    <>
      ...
      <div className="hidden lg:flex lg:flex-col lg:w-60 lg:fixed lg:inset-y-0 lg:z-50 lg:bg-white lg:shadow-xl">
        ...
        {/* User Profile */}
        <div className="absolute bottom-0 w-60 p-4 border-t border-slate-200 bg-white">
          <div className="flex items-center">
      ...
      {/* Mobile Sidebar */}
      <div className={cn(
        "fixed inset-y-0 left-0 z-50 w-60 bg-white shadow-xl transform transition-transform duration-300 ease-in-out lg:hidden",
        ...
        {user?.role === 'client' && (
          <div className="absolute bottom-20 w-60 p-3">
            <div className={cn(
